...
class StatsController {
    constructor() {
        ...
        this.getCountAllAds = this.getCountAllAds.bind(this);
        this.getCountPendingAds = this.getCountPendingAds.bind(this);
        this.getCountActiveComplaints = this.getCountActiveComplaints.bind(this);
        this.getCountLostAds = this.getCountLostAds.bind(this);
        this.getCountFoundAds = this.getCountFoundAds.bind(this);
        this.getAdsGraphData = this.getAdsGraphData.bind(this);
        this.getCategoriesStats = this.getCategoriesStats.bind(this);
    }
